...
static_assert(1 >= 0
   ...
   */
      ...
      #error "Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN requires  to match Z_MIN_ENDSTOP_INVERTING."
    #endif
  #elif ENABLED(Z_MIN_PROBE_ENDSTOP)
    #if !HAS_Z_MIN_PROBE_PIN
      #error "Z_MIN_PROBE_ENDSTOP requires the Z_MIN_PROBE_PIN to be dZ_MIN_ENDSTOP_INVERTINGefined."
    #endif
  #else
